...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/checkboxGet', [UserSettingsController::class, 'index'])->name('checkbox.get');
    Route::post('/checkbox/store', [UserSettingsController::class, 'index'])->name('2fa.enable.store');
    Route::post('/emailSenttOEnable2FA', [UserSettingsController::class, 'index'])->name('email.sent');
    Route::post('/enableEmailOtpVerify', [UserSettingsController::class, 'index'])->name('enable.email.otp');
